...
def plot_method_mix_evolution(sim, start_year, end_year, intervention_year, location, title='Method Mix Over Time', save_path=None):
...
def plot_new_method_adoption(sim, start_year, end_year, intervention_year, location, save_path=None):
    ...
    if new_method_names:
        ...
        for idx, name in enumerate(new_method_names):
            ...
            ax.plot(years, method_proportion * 100, 
                    color=color, linewidth=2, label=f'{method_label} Trend')
        ...
        ax.axvline(intervention_year, color='red', linestyle='--', linewidth=1.5, 
        ...
        ax.text(0.02, 0.97, info_text,
               ...
               bbox=dict(boxstyle='round,pad=0.8', facecolor='lightgreen', alpha=0.85, edgecolor='darkgreen', linewidth=1))
...
def plot_method_comparison_bar(baseline_sim, intervention_sim, start_year, end_year, intervention_year, location, save_path=None):
...
def plot_cpr_comparison(baseline_sim, intervention_sim, start_year, end_year, intervention_year, location, save_path=None):
...
def plot_births_comparison(baseline_sim, intervention_sim, start_year, end_year, intervention_year, location, save_path=None):
...
def create_summary_figure(baseline_sim, intervention_sim, start_year, end_year, intervention_year, location, save_path=None):
    ...
    if new_method_names:
        ...
        for idx, name in enumerate(new_method_names):
            ...
            ax1.plot(years, method_proportion, color=color, linewidth=1.5, label=f'{method_label} Users')
            
            # Mark intervention yera with a vertical line      
            ax1.axvline(intervention_year, color='red', linestyle='--', linewidth=1, alpha=0.7, label='Introduction')  
